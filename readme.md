...
- [FluentStorage](https://github.com/robinrodricks/FluentStorage) - .NET polycloud storage framework which provides a unified polycloud API across 15+ clouds including special support for Cloudflare R2
